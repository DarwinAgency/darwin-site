...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/agence-seo`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE}/agence-seo/audit-seo`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    ...
    { url: `${BASE}/agence-media/audit-strategie-digitale/objectifs-marketing-digital`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.6 },
    { url: `${BASE}/agence-media/audit-strategie-digitale/indicateurs-de-performance-mix-marketing`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.6 },
