...
const auditPillars = [
  {
    id: '01',
    title: 'Analyse des leviers actifs',
    desc: "On passe au crible chaque canal actif : sa <strong>contribution réelle au chiffre d'affaires</strong>, son coût d'acquisition, sa cohérence avec votre cible. Référencement naturel, campagnes payantes, réseaux sociaux, emailing, contenu, parcours utilisateur — rien n'est laissé de côté. Nous évaluons votre communication digitale dans sa globalité, y compris l'expérience vécue par vos visiteurs à chaque point de contact.",
    items: ['Performance par canal (volume, coût, conversion)', 'Cohérence cibles stratégiques / audiences touchées', 'Communication social media & alignement objectifs', 'Identification des redondances et trous dans le parcours'],
  },
  {
    id: '02',
    title: 'Benchmark & positionnement',
    desc: "Vos <strong>KPIs internes ne suffisent pas</strong>. Nous intégrons des données de marché, des benchmarks sectoriels et des analyses concurrentielles pour situer votre performance dans un contexte réel. L'idée : comprendre si votre stagnation est un problème interne ou une tendance de marché, et identifier les <strong>espaces de croissance que vos concurrents exploitent déjà</strong>.",
  ...
  },
  {
    ...
    desc: "L'audit se situe exactement à la <strong>jonction du <a href='/agence-media/audit-strategie-digitale/marketing-strategique-vs-marketing-operationnel' style='color:#29C5F5;text-decoration:underline;text-underline-offset:3px'>marketing stratégique et opérationnel</a></strong>. D'un côté, il interroge la vision : vos objectifs sont-ils clairs ? Votre positionnement est-il traduit dans vos actions digitales ? Votre segmentation reflète-t-elle la réalité de votre marché ? De l'autre, il plonge dans l'exécution : vos campagnes atteignent-elles les bonnes personnes ? Vos outils sont-ils correctement paramétrés ? Vos données remontent-elles là où elles doivent remonter ? La plupart des problèmes de performance naissent dans le décalage entre ces deux niveaux. Pas dans un nouvel outil ou un budget supplémentaire. Dans la remise en cohérence de ce qui existe déjà.",
...
const methodologySteps = [
  { num: '01', title: 'Définition du périmètre', desc: "On ne peut pas tout auditer avec la même profondeur en même temps. Il faut prioriser selon vos enjeux : est-ce l'acquisition qui pose question ? La rétention ? La visibilité organique ? Le coût par lead ? Ce <strong>cadrage initial</strong> conditionne la pertinence de tout le reste." },
  { num: '02', title: 'Immersion & collecte', desc: "On collecte les données existantes : <strong>analytics, CRM, outils publicitaires, rapports précédents</strong>, historique des actions. On échange avec vos équipes pour comprendre les choix passés, les contraintes internes, les <a href='/agence-media/audit-strategie-digitale/objectifs-marketing-digital' style='color:#29C5F5;text-decoration:underline;text-underline-offset:3px'>objectifs qui ont évolué</a>. L'information brute ne suffit pas — il faut la contextualiser." },
  { num: '03', title: 'Analyse & croisement des données', desc: "Pas uniquement vos KPIs internes — on intègre aussi des données de marché, des benchmarks sectoriels, des analyses concurrentielles. L'idée est de situer votre performance dans un contexte réel, pas dans un vide. Canal par canal, avec une attention particulière aux <strong>interactions entre leviers</strong>. Un contenu bien référencé qui ne génère aucun lead, ce n'est pas forcément un problème de SEO — c'est peut-être un problème de parcours, de CTA, ou de ciblage en amont. Les silos d'analyse passent à côté de ces connexions. Nous croisons les <a href='/agence-media/audit-strategie-digitale/indicateurs-de-performance-mix-marketing' style='color:#29C5F5;text-decoration:underline;text-underline-offset:3px'>indicateurs de performance</a> pour révéler les vraies causes." },
  { num: '04', title: 'Formalisation des recommandations', desc: "Pas une liste à la Prévert. Un <strong>plan structuré</strong>, avec des priorités, des estimations de ressources nécessaires, et des indicateurs de suivi pour mesurer l'impact dans le temps. Ce livrable est conçu pour être <strong>actionnable immédiatement</strong> — par votre équipe ou par un partenaire externe." },
]

const signals = [
  { label: 'Empilement sans architecture', desc: "Un canal ajouté ici, un outil adopté là, une campagne reconduite par habitude. Au fil du temps, le plan marketing ressemble davantage à un <strong>empilement qu'à une architecture</strong>. L'audit remet de l'ordre." },
  { label: 'Budget qui s\'envole, résultats qui stagnent', desc: "Vous continuez à investir dans des leviers dont vous ne mesurez plus vraiment l'impact. Vous hésitez à couper parce que <strong>vous ne savez pas ce qui tient</strong> et ce qui est du bruit." },
  { label: 'Pilotage à l\'intuition', desc: "Sans vision consolidée de vos performances par canal, vous <strong>pilotez à l'intuition</strong>. C'est humain. Mais ça coûte cher — surtout quand les budgets se comptent en dizaines de milliers d'euros mensuels." },
  { label: 'Décalage stratégie / exécution', desc: "Une stratégie bien posée mais mal déployée. Ou des actions techniques solides, <strong>déconnectées d'un cap</strong>. L'audit met ces décalages en lumière — c'est souvent là que se trouvent les gains les plus immédiats." },
]
...
export default function AuditStrategieDigitalePage() {
  return (
    <main>
        ...
        <div className="rsp-hero-grid" style={{ maxWidth: 1280, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', minHeight: 600 }}>
          ...
          <div className="rsp-hero-text" style={{ padding: '100px 64px 80px 32px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            ...
            <p style={{ fontSize: '1rem', color: '#555', lineHeight: 1.8, marginBottom: 40, textAlign: 'justify' }}>
              Vous investissez en digital depuis des années. Des campagnes tournent, vous publiez quotidiennement, des budgets se dépensent. Mais sauriez-vous dire, à l&apos;instant T, <strong>ce qui fonctionne vraiment </strong> et ce qui coûte sans produire ? C&apos;est précisément la question à laquelle un audit de stratégie digitale apporte une réponse. Pas un diagnostic vague. Une lecture lucide de votre mix marketing, levier par levier, pour reprendre la main.
            </p>
        ...
        <div className="rsp-2col" style={{ maxWidth: 1280, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1.4fr', gap: 80, alignItems: 'start' }}>
          ...
          <div>
            ...
            <p style={{ fontSize: '1rem', color: 'rgba(255,255,255,0.8)', lineHeight: 1.85, textAlign: 'justify' }}>
              Ce n&apos;est pas un rapport de plus. C&apos;est un <strong style={{ color: '#fff' }}>outil de décision</strong>.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="rsp-sidebar-layout" style={{ display: 'grid', gridTemplateColumns: '1fr 1.6fr', gap: 80, alignItems: 'start' }}>
            <div className="rsp-sticky" style={{ position: 'sticky', top: 120 }}>
              ...
              <p style={{ fontSize: '0.95rem', color: '#666', lineHeight: 1.8, textAlign: 'justify' }}>
                Chaque audit que nous menons suit un cadre rigoureux, mais il s&apos;adapte à la réalité de votre entreprise. Il n&apos;existe pas d&apos;audit standard — parce qu&apos;il n&apos;existe pas deux <Link href="/agence-media/audit-strategie-digitale/mix-marketing-interne-ou-externe" style={{ color: '#29C5F5', textDecoration: 'underline', textUnderlineOffset: '3px' }}>mix marketing</Link> identiques.
              </p>
            </div>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
              {[
                ...
                { title: 'Pas de vente déguisée', desc: "L'audit est un outil de décision, pas un prétexte pour vendre des prestations. Si votre mix est sain, on vous le dit." },
              ].map((item) => (
      ...
      {/* ── LIENS INTERNES — SOUS-PAGES AUDIT ────────────── */}
      <section style={{
