...
const auditPillars = [
  ...
  },
  {
    ...
    desc: "Vos <strong>KPIs ne suffisent pas</strong>. Nous intégrons des données de marché, des benchmarks sectoriels et des analyses concurrentielles pour situer votre performance dans un contexte réel. L'idée : comprendre si votre stagnation est un problème spécifique ou une tendance de marché, et identifier les <strong>espaces de croissance que vos concurrents exploitent déjà</strong>.",
  ...
  },
  {
    ...
    desc: "On examine aussi ce qui manque — les <strong>canaux sous-exploités</strong>, les données non collectées, les opportunités manquées, les pépites cachées. Des données mal collectées sont mal stockées et exploitées par vos plateformes publicitaires, un réseau social où votre cible est active mais où vous n'avez aucune présence en ligne, un format / emplacement que vous n'avez jamais testé, une place libre sur un sujet que vos concurrents n'adressent pas encore. L'audit révèle les <strong>angles morts de votre mix marketing</strong> et les transforme en leviers actionnables.",
...
const signals = [
  ...
  { label: 'Pilotage à l\'intuition', desc: "Sans vision experte et consolidée de vos performances par canal, vous <strong>pilotez à l'intuition</strong>. C'est humain. Mais ça coûte cher — surtout quand les budgets se comptent en dizaines de milliers d'euros mensuels." },
        ...
        <div className="rsp-hero-grid" style={{ maxWidth: 1280, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', minHeight: 600 }}>
          ...
          <div className="rsp-hero-text" style={{ padding: '100px 64px 80px 32px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            ...
            <p style={{ fontSize: '1rem', color: '#555', lineHeight: 1.8, marginBottom: 40, textAlign: 'justify' }}>
              Vous investissez en digital depuis des années. Des campagnes tournent, vos annonces sont diffusées quotidiennement, des budgets sont investis. Mais sauriez-vous dire, à l&apos;instant T, <strong>ce qui fonctionne vraiment</strong> et les réseaux qui coûtent avec peu de résultats et de rentabilité ? C&apos;est précisément la question à laquelle un audit de stratégie digitale apporte une réponse pour une marque ou une entreprise. Pas un diagnostic vague. Une lecture lucide et experte de votre mix marketing, levier par levier, pour reprendre la main.
            </p>
        ...
        <div className="rsp-2col" style={{ maxWidth: 1280, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1.4fr', gap: 80, alignItems: 'start' }}>
          ...
          <div>
            <p style={{ fontSize: '1rem', color: 'rgba(255,255,255,0.8)', lineHeight: 1.85, marginBottom: 20, textAlign: 'justify' }}>
              L&apos;audit d&apos;une stratégie digitale, c&apos;est un état des lieux structuré de votre présence sur internet et sur le digital, pour tous les canaux déployés : référencement naturel, LLM, référencement payant, emailing, DOOH, site web, SMS, outils de suivi analytics, collecte et stockage des informations. L&apos;objectif n&apos;est pas de tout remettre en cause. C&apos;est de comprendre où vous en êtes, de mesurer l&apos;écart entre vos <Link href="/agence-media/audit-strategie-digitale/objectifs-marketing-digital" style={{ color: '#29C5F5', textDecoration: 'underline', textUnderlineOffset: '3px' }}>objectifs</Link> et vos résultats réels, et d&apos;identifier de possibles points de friction qui potentiellement freinent votre performance.
            </p>
            <p style={{ fontSize: '1rem', color: 'rgba(255,255,255,0.8)', lineHeight: 1.85, marginBottom: 20, textAlign: 'justify' }}>
