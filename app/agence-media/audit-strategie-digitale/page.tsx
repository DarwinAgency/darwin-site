...
const auditPillars = [
  ...
  },
  {
    ...
    desc: "Vos KPIs ne suffisent pas. Nous intégrons des données de marché, des benchmarks sectoriels et des analyses concurrentielles pour situer votre performance dans un contexte réel. L'idée : comprendre si votre stagnation est un problème spécifique ou une tendance de marché, et identifier les <strong>espaces de croissance que vos concurrents exploitent déjà</strong>.",
          ...
          <div className="rsp-4col" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 16 }}>
            {[
              ...
              <div key={link.href} className="levier-card" style={{ background: '#fff', overflow: 'hidden', border: '1px solid #ebebeb', borderTop: '3px solid #FFF127', padding: '28px 24px' }}>
                ...
                <Link href={link.href} style={{ fontSize: '0.72rem', fontWeight: 700, color: '#0a0a0a', letterSpacing: '0.1em', textTransform: 'uppercase' }}>DÉCOUVRIR →</Link>
              </div>
            ))}
          </div>
        </div>
