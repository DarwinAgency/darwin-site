...
const services = [
  { href: '/agence-media/audit-strategie-digitale', title: 'Audit & Stratégie digitale', accent: '#FFF127', desc: "Analyse complète de votre écosystème digital : campagnes en cours, performances historiques, positionnement concurrentiel et cohérence de votre mix marketing. Nous identifions les quick wins — ces gains rapides sur les leviers existants qui produisent des résultats immédiats — et posons les bases d'un dispositif efficace sur la durée. Chaque recommandation est argumentée avec des projections réalistes, pas des promesses en l'air." },
...
const faqs = [
  ...
  },
  {
    ...
    a: "Nous couplons des dispositifs en ultra locale, pour avoir une couverture sur cible optimale et maximiser votre visibilité. Nous analysons en temps réel, les retombées en magasin afin de piloter les différents leviers et atteindre le Cout par Visite les plus intéressants.",
  },
  {
    q: "Est-ce qu'une agence média comme DARWIN peut intervenir dans mon secteur d'activité ?",
    a: "Oui. Nous accompagnons des annonceurs dans des secteurs très différents — retail, e-commerce, tourisme, services, formation, santé, immobilier, entre autres. Chaque secteur a ses propres contraintes : saisonnalité, cycles de décision, budgets, réglementation. Ce qui compte, ce n'est pas d'avoir déjà travaillé exactement dans votre niche — c'est de savoir adapter la méthode à vos enjeux spécifiques. Et ça, c'est ce que vingt-trois ans de terrain nous ont appris à faire.",
  },
  {
