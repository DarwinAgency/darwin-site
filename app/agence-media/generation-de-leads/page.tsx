...
const signals = [
  ...
  { label: 'Coût par lead en hausse, ROI flou', desc: "Les budgets augmentent, les CPL aussi. Mais sans modèle d'attribution fiable, vous ne savez pas si le problème vient du canal, du message, ou du parcours de conversion." },
]
    ...
    <main>
      ...
      <section className="rsp-section" style={{ background: '#fff', padding: '80px 32px' }}>
        <div style={{ maxWidth: 1280, margin: '0 auto' }}>
          ...
          {/* eslint-disable-next-line react/no-danger */}
          <p style={{ fontSize: '0.95rem', color: '#555', lineHeight: 1.85, maxWidth: 960, margin: '48px auto 0', textAlign: 'center' }} dangerouslySetInnerHTML={{ __html: "L'enjeu n'est pas d'activer tous ces canaux. C'est de <strong>les orchestrer</strong>. Un prospect touché en display, retouché en emailing, qui convertit via un formulaire SEO — c'est un parcours courant. Encore faut-il le tracer, le mesurer, et l'optimiser. C'est exactement ce que permet un <strong>modèle d'attribution multi-touch</strong> bien configuré." }} />
        </div>
      </section>
